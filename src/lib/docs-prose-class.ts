export const docsProseClass = [
	...
	'prose-h3:mt-6 prose-h3:mb-1 prose-h3:text-lg prose-h3:font-semibold prose-h3:text-fyra-gray-100',
	'prose-h4:mt-4 prose-h4:mb-1 prose-h4:text-base prose-h4:font-semibold prose-h4:text-fyra-gray-200',
	'prose-p:text-sm prose-p:leading-relaxed prose-p:text-fyra-gray-300',
	...
	'prose-li:text-sm prose-li:text-fyra-gray-300 prose-blockquote:border-fyra-red-500 prose-blockquote:text-fyra-gray-200 prose-th:text-fyra-gray-100 prose-td:text-fyra-gray-300 prose-hr:my-8 prose-hr:border-fyra-gray-700'
].join(' ');
