...
<div class="relative isolate overflow-hidden border-b border-fyra-gray-800 px-6 pt-14 lg:px-8">
	...
	<div class="mx-auto max-w-4xl py-24 sm:py-32 text-center">
		...
		<div class="mb-8 flex justify-center">
			<div class="inline-flex items-center gap-2 border border-fyra-gray-700 bg-fyra-gray-800/60 px-3.5 py-2 text-sm text-fyra-gray-400">
				<span>In partnership with</span>
				<span class="font-semibold text-fyra-gray-100">DeepComputing</span>
			</div>
		</div>
		...
		<h2 class="text-4xl font-semibold tracking-tight text-balance sm:text-6xl mb-8">
			<span class="text-fyra-red-400">now in the cloud.</span>
		</h2>
		<p class="text-base text-fyra-gray-400 sm:text-lg/7 max-w-lg mx-auto">
			RISC-V VPS powered by DeepComputing hardware. Run your workloads on real open-ISA silicon — no proprietary lock-in at any layer of the stack.
		</p>
		<div class="mt-10 flex items-center justify-center gap-6 flex-wrap">
			<a
				href="#plans"
