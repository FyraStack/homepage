...
Colocate in our Illinois space with power redundancy, solid network connectivity, and support from people who've actually racked servers before.			</p>
		...
		<div class="grid grid-cols-2 gap-px bg-fyra-gray-800">
			...
			<div class="bg-fyra-gray-900 p-8">
				<p class="text-lg font-semibold leading-snug text-fyra-gray-50">IPMI remote access</p>
				<p class="mt-1.5 text-sm leading-relaxed text-fyra-gray-400">Full out-of-band management over a simple VPN connection.</p>
			</div>

			<!-- Power -->
			<div class="bg-fyra-gray-900 p-8">
				<p class="text-lg font-semibold text-fyra-gray-50">Redundant power</p>
				<p class="mt-1.5 text-sm leading-relaxed text-fyra-gray-400">A+B feeds, UPS, and generator backup keep your server on.</p>
			</div>

			<!-- Support -->
			<div class="bg-fyra-gray-900 p-8">
				<p class="text-lg font-semibold text-fyra-gray-50">Real support</p>
				<p class="mt-1.5 text-sm leading-relaxed text-fyra-gray-400">By the engineers who have actually racked servers before.</p>
			</div>

			<!-- Pricing -->
			<div class="bg-fyra-gray-900 p-8">
				<p class="text-lg font-semibold text-fyra-gray-50">Honest pricing</p>
				<p class="mt-1.5 text-sm leading-relaxed text-fyra-gray-400">No hidden power fees, no egress charges, no surprise bills.</p>
			</div>
