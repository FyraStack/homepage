	...
	>
		<div class="px-6 py-10 md:px-10">
			<p class="text-base leading-relaxed text-fyra-gray-300">
				Fyra Stack is an independent infrastructure provider based in the Midwest. We run bare metal
				because we believe the best hosting is honest: fast hardware, flat pricing, and no locked-in
